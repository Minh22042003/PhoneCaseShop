...
export const MOCK_PRODUCTS_LIST = [
    { id: 'inv1', phone_model_id: 'pm1', case_type_id: 'ct1', case_type_name: 'Ốp lưng dẻo iPhone 14 Pro', case_type_price: 299000, case_type_description: 'Ốp lưng làm từ chất liệu TPU dẻo dai, chống sốc tốt.', case_type_image_url: 'https://placehold.co/400x400/8B5CF6/ffffff?text=Glass+Case'},
    { id: 'inv2', phone_model_id: 'pm1', case_type_id: 'ct2', case_type_name: 'Ốp lưng cứng iPhone 14 Pro', case_type_price: 109000, case_type_description: 'Ốp lưng làm từ chất liệu TPU dẻo dai, chống sốc tốt.', case_type_image_url: 'https://placehold.co/400x400/8B5CF6/ffffff?text=Glass+Case'},
    { id: 'inv3', phone_model_id: 'pm2', case_type_id: 'ct3', case_type_name: 'Ốp lưng dẻo Galaxy S23 Ultra', case_type_price: 99000, case_type_description: 'Ốp lưng làm từ chất liệu TPU dẻo dai, chống sốc tốt.', case_type_image_url: 'https://placehold.co/400x400/8B5CF6/ffffff?text=Glass+Case'},
    { id: 'inv4', phone_model_id: 'pm2', case_type_id: 'ct4', case_type_name: 'Ốp lưng cứng Galaxy S23 Ultra', case_type_price: 399000, case_type_description: 'Ốp lưng làm từ chất liệu TPU dẻo dai, chống sốc tốt.', case_type_image_url: 'https://placehold.co/400x400/8B5CF6/ffffff?text=Glass+Case'},
    { id: 'inv5', phone_model_id: 'pm3', case_type_id: 'ct5', case_type_name: 'Ốp lưng dẻo Pixel 7 Pro', case_type_price: 293000, case_type_description: 'Ốp lưng làm từ chất liệu TPU dẻo dai, chống sốc tốt.', case_type_image_url: 'https://placehold.co/400x400/8B5CF6/ffffff?text=Glass+Case'},
    { id: 'inv6', phone_model_id: 'pm3', case_type_id: 'ct6', case_type_name: 'Ốp lưng cứng Pixel 7 Pro', case_type_price: 267000, case_type_description: 'Ốp lưng làm từ chất liệu TPU dẻo dai, chống sốc tốt.', case_type_image_url: 'https://placehold.co/400x400/8B5CF6/ffffff?text=Glass+Case'},
];
